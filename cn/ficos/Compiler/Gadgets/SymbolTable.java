...
public class SymbolTable {
    ...
    public static FuncSymbol toString = new FuncSymbol(getName("_toString"), STRING, Arrays.asList(getName("i")), Arrays.asList(INT));
    public static FuncSymbol string_length = new FuncSymbol(getName("_string.length"), INT, Arrays.asList(getName("this")), Arrays.asList(STRING));
    public static FuncSymbol string_substring = new FuncSymbol(getName("_string.substring"), STRING, Arrays.asList(getName("this"), getName("left"), getName("right"))
            , Arrays.asList(STRING, INT, INT));
    public static FuncSymbol string_parseInt = new FuncSymbol(getName("_string.parseInt"), INT, Arrays.asList(getName("this")), Arrays.asList(STRING));
    public static FuncSymbol string_ord = new FuncSymbol(getName("_string.ord"), INT, Arrays.asList(getName("this"), getName("pos")), Arrays.asList(STRING, INT));
    public static FuncSymbol _array_size = new FuncSymbol(getName("_array.size"), INT, Arrays.asList(getName("this")), Arrays.asList(ArrayType.virtualArrayType));
    public static FuncSymbol stringConcatenate = new FuncSymbol(getName("_stringConcatenate"), STRING, Arrays.asList(getName("lhs"), getName("rhs")),
            Arrays.asList(STRING, STRING));
    public static FuncSymbol stringIsEqual = new FuncSymbol(getName("_stringIsEqual"), BOOL, Arrays.asList(getName("lhs"), getName("rhs")),
            Arrays.asList(STRING, STRING));
